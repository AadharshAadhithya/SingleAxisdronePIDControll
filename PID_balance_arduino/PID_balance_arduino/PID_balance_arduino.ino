...
double rightthrottle=1063;
double leftthrottle = 1050;//initial value of throttle to the motors
...
void setup() {
  ...
  Serial.begin(250000);
  right_prop.attach(3,1000,2000); //attatch the right motor to pin 3
  left_prop.attach(5,1000,2000);  //attatch the left motor to pin 5
...
pwmLeft = leftthrottle - PID;
pwmRight = rightthrottle + PID;
